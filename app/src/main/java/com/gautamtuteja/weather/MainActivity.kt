...
import com.gautamtuteja.weather.databinding.ActivityMainBinding
import com.gautamtuteja.weather.models.WeatherResponse
import com.gautamtuteja.weather.network.WeatherService
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!isLocationEnabled()){
            Toast.makeText(this, "LocationOff.TurnOn", Toast.LENGTH_SHORT).show()
